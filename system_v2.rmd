...
fit_b1z_1 <- lm(formula = b1z_1 ~ w1z_1 + w1r_1 + w1p_1, data= train_data)
fit_b1z_2 <- lm(formula = b1z_2 ~ w1z_2 + w1r_2 + w1p_2, data= train_data)
fit_b1z_3 <- lm(formula = b1z_3 ~ w1z_3 + w1r_3 + w1p_3, data= train_data)
fit_b1z_4 <- lm(formula = b1z_4 ~ w1z_4 + w1r_4 + w1p_4, data= train_data)
fit_b1z_5 <- lm(formula = b1z_5 ~ w1z_5 + w1r_5 + w1p_5, data= train_data)
...
fit_b1r_1 <- lm(formula = b1r_1 ~ w1z_1 + w1r_1 + w1p_1, data= train_data)
fit_b1r_2 <- lm(formula = b1r_2 ~ w1z_2 + w1r_2 + w1p_2, data= train_data)
fit_b1r_3 <- lm(formula = b1r_3 ~ w1z_3 + w1r_3 + w1p_3, data= train_data)
fit_b1r_4 <- lm(formula = b1r_4 ~ w1z_4 + w1r_4 + w1p_4, data= train_data)
fit_b1r_5 <- lm(formula = b1r_5 ~ w1z_5 + w1r_5 + w1p_5, data= train_data)
...
fit_b1p_1 <- lm(formula = b1p_1 ~ w1z_1 + w1r_1 + w1p_1, data= train_data)
fit_b1p_2 <- lm(formula = b1p_2 ~ w1z_2 + w1r_2 + w1p_2, data= train_data)
fit_b1p_3 <- lm(formula = b1p_3 ~ w1z_3 + w1r_3 + w1p_3, data= train_data)
fit_b1p_4 <- lm(formula = b1p_4 ~ w1z_4 + w1r_4 + w1p_4, data= train_data)
fit_b1p_5 <- lm(formula = b1p_5 ~ w1z_5 + w1r_5 + w1p_5, data= train_data)
...
fit_b2z_1 <- lm(formula = b2z_1 ~ w2z_1 + w2r_1 + w2p_1, data= train_data)
fit_b2z_2 <- lm(formula = b2z_2 ~ w2z_2 + w2r_2 + w2p_2, data= train_data)
fit_b2z_3 <- lm(formula = b2z_3 ~ w2z_3 + w2r_3 + w2p_3, data= train_data)
fit_b2z_4 <- lm(formula = b2z_4 ~ w2z_4 + w2r_4 + w2p_4, data= train_data)
fit_b2z_5 <- lm(formula = b2z_5 ~ w2z_5 + w2r_5 + w2p_5, data= train_data)
...
fit_b2r_1 <- lm(formula = b2r_1 ~ w2z_1 + w2r_1 + w2p_1, data= train_data)
fit_b2r_2 <- lm(formula = b2r_2 ~ w2z_2 + w2r_2 + w2p_2, data= train_data)
fit_b2r_3 <- lm(formula = b2r_3 ~ w2z_3 + w2r_3 + w2p_3, data= train_data)
fit_b2r_4 <- lm(formula = b2r_4 ~ w2z_4 + w2r_4 + w2p_4, data= train_data)
fit_b2r_5 <- lm(formula = b2r_5 ~ w2z_5 + w2r_5 + w2p_5, data= train_data)
...
fit_b2p_1 <- lm(formula = b2p_1 ~ w2z_1 + w2r_1 + w2p_1, data= train_data)
fit_b2p_2 <- lm(formula = b2p_2 ~ w2z_2 + w2r_2 + w2p_2, data= train_data)
fit_b2p_3 <- lm(formula = b2p_3 ~ w2z_3 + w2r_3 + w2p_3, data= train_data)
fit_b2p_4 <- lm(formula = b2p_4 ~ w2z_4 + w2r_4 + w2p_4, data= train_data)
fit_b2p_5 <- lm(formula = b2p_5 ~ w2z_5 + w2r_5 + w2p_5, data= train_data)
